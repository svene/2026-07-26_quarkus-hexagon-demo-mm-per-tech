...
public record NonFoodDelivery(String productName, int quantity) {
	...
	public static Optional<NonFoodDelivery> parse(String productName, int quantity) {
		// TODO: validate productName
		return isValid(quantity)
			? Optional.of(new NonFoodDelivery(productName, quantity))
			: Optional.empty();
	}
}
