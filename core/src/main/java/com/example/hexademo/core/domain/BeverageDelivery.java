...
public record BeverageDelivery(String productName, int quantity) {
	...
	public static Optional<BeverageDelivery> parse(String productName, int quantity) {
		// TODO: validate productName
		return isValid(quantity)
			? Optional.of(new BeverageDelivery(productName, quantity))
			: Optional.empty();
	}
}
