...
public record VegetableDelivery(String productName, int quantity) {
	...
	public static Optional<VegetableDelivery> parse(String productName, int quantity) {
		// TODO: validate productName
		return isValid(quantity)
			? Optional.of(new VegetableDelivery(productName, quantity))
			: Optional.empty();
	}
}
