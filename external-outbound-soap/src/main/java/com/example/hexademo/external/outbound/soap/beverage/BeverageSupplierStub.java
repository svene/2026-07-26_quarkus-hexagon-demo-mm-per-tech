package com.example.hexademo.external.outbound.soap.beverage;
...
@ApplicationScoped
@WebService(
    endpointInterface = "com.example.hexademo.external.outbound.soap.beverage.BeverageOrderService",
